...
sentence_features = c("sent_afinn", "sent_bing", "n_polite", "n_first_person", "n_first_personp",
...
statistiche = function(data, lev= levels(data$obs), model = NULL){
  c(
    twoClassSummary(data=data, lev= lev, model),
    prSummary(data=data, lev= lev, model),
    mnLogLoss(data=data, lev= lev, model),
    defaultSummary(data=data, lev= lev, model)
  )
}
