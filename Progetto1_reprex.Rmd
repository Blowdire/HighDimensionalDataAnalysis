...
As initially said, the training time of the model was also calculated and we observed that the speed-up of using factors is in general higher and this happened because extending the number of predictors (by generating dummies) requires more computational time than using factor levels.

In conclusion, after these experiments, it is possible to say that it is better to use predictors without converting them to dummy variables.
