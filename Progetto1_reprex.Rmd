...
![Plot of hash collision rate for feature hasing of different sizes.](./images/collisionRates.png)
...
ggpubr::ggarrange(plot_a, plot_b,
                  labels=c("a.","b."))
```
![Plot of the magnitude of the estimates (mean between raw and shrinken odds) versus the difference between the two.](./images/logoddsComparison.png)
