...
la tecnica utilizzata è stata la boosting, ogni modello fa una previsione e si ricava una previsione finale applicando dei pesi a seconda dell'accurancy in fase di learning.

il random forest è un boosting di decision tree, si mettono insieme le previsioni di tante alberi pesando per accurancy
